...
function pesquisarReceitas() {
    ...
    var options = {
        ...
        item: '<li><h3 class="campoTitulo"></h3><h6 class="campoDescricao"></h6><a href="doces.html"><h6 class="categoria"></h6></a><p class="receita"></p></li>',
    }

    $('.list').hide()

    let receitas = new List('PesquisarReceitas', options, itens.receitas)

    $('#inputPesquisarObjetos').on('input', function() {
        setTimeout(() => {
